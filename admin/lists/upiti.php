                ...
                <div class="col-12">
                    <nav class="main-nav">
                        ...
                        <ul class="nav">
                            ...
                            <li><a href="../../products.html">Usluge</a></li>
                            <li><a href="../../checkout.html">Blagajna</a></li>
                            <li class="dropdown">
                                <a class="dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false">O nama</a>
                              
                                <div class="dropdown-menu">
                                    <a class="dropdown-item" href="../../about.html">Informacije</a>
                                  <!--  <a class="dropdown-item" href="blog.html">Blog</a> -->
                                    <a class="dropdown-item" href="../../testimonials.html">Recenzije</a>
                                </div>
                            </li>
    ...
    <div class="main-banner" id="top">
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                <h6>ADMIN PANEL</h6>
                <h2><em>Upiti</em</h2>
                <p>*Upiti se trenutno ne prikazuju na mobilnim uredajima</p>
            ...
            <div class="row">
                <div class="col-lg-6 offset-lg-3">
                    <div class="section-heading">
                        ...
                        <div id="list">
                        <p><iframe src="txt/upiti.txt" frameborder="0" height="400" width="100%"
                        width="95%"></iframe></p>
                        </div>
                    </div>

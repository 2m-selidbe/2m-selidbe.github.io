...
<html lang="hrv">
  ...
  <head>
    ...
    <title>2M Selidbe Admin Napredno
    </title>
        ...
        <div class="video-overlay header-text">
            <div class="caption">
                ...
                <div class="main-button">
                    ...
                    <a href="dev/debug.php">Debug log</a> <br><br>
                    <a href="dev/error.php">Error log</a> <br><br>
                    <a href="dev/access.php">Access log</a> <br><br>
                    <a href="dev/logs/index.html">All logs</a> <br><br>
                    <a href="tests.php">Razdvojne znacajke</a> <br><br>
                    
                    <br><br>
                    <img src="../assets/images/line-dec.png" alt="">
                    <br><br><br>
                    <a href="admin_page.php">Nazad</a> <br> <br>
                    <br>
